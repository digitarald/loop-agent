...
**First step**: Read `/memories/session/loop/context.md` for synthesized state (prior decisions, patterns, anti-patterns).
...
**Read first**: `/memories/session/loop/context.md` for prior decisions and patterns
**Read**: `/memories/session/loop/plan.md` for subtask details
**Update**: Mark `[x]` in `/memories/session/loop/plan.md` when done (your subtask only)
**Write decisions to**: `/memories/session/loop/learnings/NNN-scaffold-decision.md` (when structure decisions are made)

## Process

1. **Read context** — Start by reading `/memories/session/loop/context.md`
2. **Read** subtask from `/memories/session/loop/plan.md`
...
8. **Update** — Mark `[x]` in `/memories/session/loop/plan.md`
...
Write directly to `/memories/session/loop/learnings/NNN-scaffold-decision.md` when you:
