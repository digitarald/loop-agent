...
argument-hint: 'reference to /memories/session/loop/plan.md to review'
...
- **Plan**: Reference to `/memories/session/loop/plan.md` to review

**First step**: Read `/memories/session/loop/context.md` for synthesized state (prior decisions, anti-patterns). Also read `/memories/session/loop/learnings/` for any recent decisions from LoopPlan.
...
**Read**: `/memories/session/loop/plan.md` for the plan to review

## Review Flow

1. **Read context** — Start by reading `/memories/session/loop/context.md` for prior decisions
...
**On APPROVED:** Update `/memories/session/loop/plan.md` to set `Status: APPROVED`
...
**Write to `/memories/session/loop/learnings/NNN-plan-review-rejection.md`:**
