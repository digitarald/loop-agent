...
**Check decision coherence.** Does this implementation follow the decisions in `/memories/session/loop/learnings/`? If code contradicts a documented decision, that's a Critical issue.
